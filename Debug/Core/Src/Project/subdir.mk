...
clean-Core-2f-Src-2f-Project:
	-$(RM) ./Core/Src/Project/getSongInfo.cyclo ./Core/Src/Project/getSongInfo.d ./Core/Src/Project/getSongInfo.o ./Core/Src/Project/getSongInfo.su ./Core/Src/Project/project.cyclo ./Core/Src/Project/project.d ./Core/Src/Project/project.o ./Core/Src/Project/project.su ./Core/Src/Project/song.cyclo ./Core/Src/Project/song.d ./Core/Src/Project/song.o ./Core/Src/Project/song.su ./Core/Src/Project/tone.cyclo ./Core/Src/Project/tone.d ./Core/Src/Project/tone.o ./Core/Src/Project/tone.su
